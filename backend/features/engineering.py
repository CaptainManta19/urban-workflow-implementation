...
NOTEBOOK_REFERENCE = "notebooks/combined_dataset.ipynb"
...
def save_feature_definitions(
    ...
    specs = [spec.model_dump() for spec in build_feature_definitions()]
...
def build_feature_definitions() -> list[FeatureTableSpec]:
